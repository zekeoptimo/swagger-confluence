package com.zekeoptimo.swagger2confluence.examples
...
def template = new File("../../../../../resources/basic-template.html")
def swaggerFile = new File("../../../../../resources/petstoreswagger.json")
